...
The simpler model appears to lag the realization.
These simpler model perform much better than the complex models.

These models appear to predict the response variable at a lag.
...
models <- append(model.none, model.const)
