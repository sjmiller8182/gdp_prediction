...
```{r echo=FALSE}
print(paste0("The ASE value with the naive median ensemble = ", round(ASE1, 4)))
```
...
```{r echo=FALSE}
print(paste0("The ASE value with the naive mean ensemble = ", round(ASE2, 4)))
```
...
```{r echo=FALSE}
print(paste0("The ASE value with the glm ensemble = ", round(ASE3, 4)))
```
