...
Additionally, the Ljung-Box test fails to reject the null hypothesis that the realization is not white noise at K = 24 and K = 48.
...
evaluate_residuals(as.numeric(model.nnfor$net$response))
